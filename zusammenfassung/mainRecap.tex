...
% Einzelne Bilder auf einer Seite werden soweit wie moeglich zum Seitenanfang gepackt
\makeatletter
\setlength{\@fptop}{0pt}
\makeatother
...
\clearpage
\input{iterator/docIteratorPattern}
\clearpage
\input{composite/docCompositePattern}
\clearpage
\input{builder/docBuilderPattern}
\clearpage
\input{memento/docMementoPattern}
\clearpage
